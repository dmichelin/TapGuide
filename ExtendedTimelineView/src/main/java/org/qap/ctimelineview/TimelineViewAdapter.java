...
public class TimelineViewAdapter extends ArrayAdapter<TimelineRow> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        TextView rowOpenAtTimeTv = view.findViewById(R.id.open_time_tv);
        TextView rowClosedAtTimeTv = view.findViewById(R.id.closed_time_tv);
        TextView distanceTv = view.findViewById(R.id.distance_tv);
        ...
        rowOpenAtTimeTv.setText(row.getClosedAt());
        rowClosedAtTimeTv.setText(row.getOpenAt());
        String distanceString = String.format(Locale.US, "%.2f mi", row.getDistanceInMeters() * 0.000621371192);
