...
public class TimelineRow {
    ...
    public TimelineRow(int id, Date date, String title, String description, String image, int bellowLineColor, int bellowLineSize, int imageSize, int backgroundColor, int backgroundSize, int dateColor, int titleColor, int descriptionColor) {
        this.id = id;
        this.date = date;
        this.title = title;
        this.description = description;
    ...
    public void setBelowLineSize(int bellowLineSize) {
        this.bellowLineSize = bellowLineSize;
    }
    ...
    public void setBelowLineColor(int bellowLineColor) {
        this.bellowLineColor = bellowLineColor;
    }
